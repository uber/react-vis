...
|----------------------|-----|-----|---------|-----------|--------|
| [LineSeries](documentation/api-reference/line-series.md)  |  +  |  +  | +       |           |        |
| `AreaSeries`         |  +  |  +  | +       |           |        |
| [LineMarkSeries](documentation/api-reference/line-series.md)     |  +  |  +  | +       |     +     | +      |
| `MarkSeries`         |  +  |  +  | +       |     +     | +      |
| [VerticalBarSeries](documentation/api-reference/bar-series.md)  |  +  |  +  | +       |     +     |        |
| [HorizontalBarSeries](documentation/api-reference/bar-series.md)|  +  |  +  | +       |     +     |        |
| `VerticalRectSeries`  |  +  |  +  | +       |     +     |        |
| `HorizontalRectSeries`|  +  |  +  | +       |     +     |        |
| [HeatmapSeries](documentation/api-reference/heatmap-series.md)      |  +  |  +  | +       |     +     |        |      |
